...
public class MyBot : IChessBot
{
	...
	sbyte[,] mg_knight_table = {
		{-107, -89, -34, -49,  61, -97, -15, -107},
		{-73, -41,  72,  36,  23,  62,   7,  -17},
		{-47,  60,  37,  65,  84, 126,  73,   44},
	...
	sbyte[,] eg_pawn_table = {
		{0 ,0 ,0 ,0 ,0 ,0 ,0 ,0 },
		{126 ,122 ,117 ,110 ,114 ,110 ,123 ,126 },
